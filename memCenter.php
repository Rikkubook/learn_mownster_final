...
<body>
                    ...
                    <div class="myrobot-item myrobot-item-top">
                        ...
                        <div id="myrobot-pic-area">
                            ...
                            <div id="myrobot-stage">
                                <img src="img/img-memCenter/stage-01-01.png">
                    ...
                    <div id="content-myrobot" class="content-item">
                        ...
                        <div class="myrobot-data">
                            <table id="myrobot-table">
                                ...
                                <tr id="tr-robotname">
                                    <th>機器人姓名 : </th>
                                    <td id="myrobotName">香田家三姊妹</td>
                                </tr>

                                <tr id="tr-robotbirth">
                                    <th>機器人生日 : </th>
                                    <td id="myrobotBirth">2017-05-15</td>
                                </tr>

                                <tr id="tr-robotrank">
                                    <th>目前的排名 : </th>
                                    <td>第<span id="nowRank">18,456</span>名</td>
                                </tr>
                    ...
                    <div id="content-mydata" class="content-item">
                        ...
                        <div class="edit-area">
                            ...
                            <div class="edit-area-item item-mypsw">
                                <div class="data-input">
                                    <label>輸入新密碼 : </label>
                                    <input type="text" name="" id="memPsw">
                                </div>
                                <div class="data-input">
                                    <label>確認密碼 : </label>
    ...
    <!-- Footer -->
    <footer class="footer">
        Copyright © 2018 Davinci. All rights reserved.
    </footer>
    <!-- Footer -->
