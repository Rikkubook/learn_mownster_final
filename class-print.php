...
try{
  ...
  $sql = "SELECT classDtNo, classDtName, classDtPrice, classDtDate, classDtEnd FROM classdetails where classDtName = '3D列印' and classDtStatus = 1";
...
<div class="class__wrap">
    <div class="island__bg--class">
        <img src="img/class-img/print-island.svg" alt="island__bg">
    </div>
<!-- 背景 雲圖 -->
    ...
    <div class="container container__banner">
        <div class="printClass__title po-r">
            <div class="title__bg">
        ...
        <div class="class__banner bs-bb po-r">
            <div class="airBanner">
                <div class="banner__carousel--wrap">
                    <ul class="banner__carousel printPage">
    ...
    <div class="container c__class__print bs-bb">
        <div class="class__print--planning col-12 no-fl">
            <div class="printClass__title po-r">
                <div class="title__bg">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 336.3 140.05">
                        <defs>
            ...
            <div class="class__planning--wrap dis-f bs-bb pr-20 pr-lg-0 pl-20 pl-lg-0">
                <div class="class__planning--info col-12 col-lg-5 bs-bb no-fl card-sm">
                    ...
                    <div class="class__info--wrap">
                        <p>記得小時候去別人家看到同學床頭的公仔，是多麼讓人欣羨嗎？有時候會不會覺得，為什麼都沒辦法有隻跟別人完全不一樣，自己專屬的怪獸公仔呢？</p>
                        <p>在我們的作怪店面裡，我們可以幫你達成夢想！只要參加3D列印課程，就可以做出一隻獨一無二的怪獸公仔！不用自己備料，無需經驗，只要帶著熱誠的心，就會有專業導師教你一步步做出心目中的怪獸公仔！另外，這堂課也非常適合親子一同參與，作怪教室裡絕對是孩子能安全玩樂的場地！快來參加吧！</p>
                    </div>
                ...
                <div class="pb-lg-30 class__planning--calendar print__planning--calendar col-12 col-lg-5 bs-bb no-fl">
                    <table>
                    ...
                    <div id="printDate--secret" class="secret__info shhhhhhhh">
                        <table class="secret__class">
                            <?php while($printDateRow = $classDate->fetchObject() ){ ?>
                            <tr class="class__number <?php echo $printDateRow->classDtNo; ?>">	
                                <td class="print__class--dates"><?php echo $printDateRow->classDtDate; ?></td>
                                <td class="print__end--dates"><?php echo $printDateRow->classDtEnd; ?></td>
                            </tr>
                                <?php }?>
                        </table>
                    </div>
                    <div class="class__date">
                        <div class="class__date--info">
                            <span>上課日期</span>
                            <span id="showPrintDate" class="showDate">請於上方月曆點選日期</span>
                        </div>
                        <div class="class__date--time">
                            <span>上課時段</span>
                            <span id="showPrintTime" class="showTime">請選擇上課日期</span>
                        </div>
                        <div class="class__date--people">
                            <span>參加人數</span>
                            <select name="people" id="peopleTotalPrint" class="peopleTotal" required>
                        ...
                        <div class="class__date--price">
                            <span>總金額</span>
                            <span id="totalPricePrint">$4000元</span>
                        </div>
        ...
        <div class="class__photos">
            <div class="photo--carousel">
                <div class="item--carousel photoA">
                    <img src="img/class-img/print-class/print14.jpg" alt="3D printing photo">
                </div>
                <div class="item--carousel photoB">
                    <img src="img/class-img/print-class/print7.jpeg" alt="3D printing photo">
                </div>
                <div class="item--carousel photoC">
                    <img src="img/class-img/print-class/print11.jpeg" alt="3D printing photo">
                </div>
                <div class="item--carousel photoD">
                    <img src="img/class-img/print-class/print8.jpeg" alt="3D printing photo">
                </div>
                <div class="item--carousel photoE">
                    <img src="img/class-img/print-class/print10.jpeg" alt="3D printing photo">
                </div>
                <div class="item--carousel photoF">
                    <img src="img/class-img/print-class/print12.jpeg" alt="3D printing photo">
                </div>
            </div>
        </div>
    ...
    <div class="container c__comment">
        ...
        <div class="class__comment commentBoard ta-c bs-bb pl-lg-50 pr-lg-50 pl-20 pr-20">
            <div class="class__comment--type print__comment--type col-12 no-fl">
                ...
                <div class="col-12 col-lg-10 class__comments bs-bb">
                    <div class="comment__block bs-bb">
                        <ul class="bs-bb">
                            ...
                            <li>
                                ...
                                <?php } ?>
                                <input id="classType" type="hidden" value="1">
                            </li>
                        </ul>
                    ...
                    <div class="comment__buttons">
                        <form id="messageForm">
                            ...
                            <input type="hidden" name="messageType" id="messageType" value="1">
            ...
            <div class="comment__block--show">
                <!-- <div class="class__comment--single own__comment--print print__comment col-12 no-fl">
                    ...
                    <div class="col-12 col-lg-10 class__comments bs-bb">
                        <div class="comment__block bs-bb">
                            <ul class="bs-bb">
                                ...
                                <li><span class="comment--text print__comment--text">哪有！我做的才可愛</span></li>
                            </ul>
                            <div class="comment__image">
                                <img class="photo--btn" src="img/class-img/cuteDoll1.jpg" alt="messagePic">
                            </div>
                            <div class="comment__arrow"></div>
                        </div>
                        <div class="comment__buttons">
            ...
            <div id="online" class="payTypeDetail mt-20">
                <div class="card__number">
                    ...
                    <span class="input--wrap">
                        <input type="text" name="creditCard-1" id="cardNo1" class="mb--card--adjust">
                        <span>-</span>
                    </span>
                    <span class="input--wrap">
...
<div class="popup__comment">
    ...
    <!-- 燈箱內容 -->
    <div class="popup__box MB-confirm transform--out col-7 col-lg-2 ta-c card-lg z-i-999">
...
<div class="island__plane--wrap island__plane">
    ...
    <div class="wave--sign">
        ...
        <p class="jump__island"><a href="class-doll.php">前往布偶島</a></p>
    </div>
    <div class="p-body">
        <div class="p-parts">
            <div class="part-one">
...
<div class="balloon__island balloon__island--wrap mb">
    <div class="balloon__sign">
        ...
        <p class="jump__island--mb"><a href="class-doll.php">布偶島</a></p>
    </div>
